...
class LocalNotificationService {
  ...
  showNotification = (id, title, message, data = {}, options = {}) => {
    console.log('[LocalNotificationService] showNotification:', title);
    console.log('[LocalNotificationService] showNotification:', message);
  ...
  buildAndroidNotification = (id, title, message, data = {}, options = {}) => {
    console.log('[LocalNotificationService] buildAndroidNotification:', title);
    console.log(
