...
function POBaruSM({navigation, route}) {
      ...
      <ScrollView>
        ...
        <View style={{flex: 1}}>
          <View style={styles.formBox}>
            <Text style={[FONT_BOLD_16, {color: 'black'}]}>Sales Person</Text>
            <Text style={[FONT_BOLD_14, {color: 'black'}]}>Nama Sales</Text>
            <View style={styles.action}>
              <Picker
                ...
                <Picker.Item label="Pilih nama sales person" value="0" />
          ...
          <View style={[styles.formBox, {marginTop: 10}]}>
            <View
              ...
              <Text style={[FONT_BOLD_16, {color: 'black'}]}>Toko</Text>
              {!detailToko ? (
